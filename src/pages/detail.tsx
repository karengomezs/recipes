...
export default function Detail(props: Props) {
  ...
  const tags = arrTags?.map((tag, i) => {
    return (
      <li key={tag} className=" bg-gray-200 rounded-xl flex px-2 py-1">
        <small>{tag}</small>
      </li>
    );
  });
  ...
  return (
    <>
      <Navbar />
      <main className="flex min-h-screen flex-col px-4 max-w-6xl mx-auto my-10">
        <img
        ...
        <div className="mb-6 flex flex-col gap-2">
          ...
          <div className="flex justify-between">
            ...
            <i className="fa-sharp fa-solid fa-heart text-3xl text-red-600 sm:mr-10"></i>
          </div>
        ...
        <p className="sm:max-w-[80%] mx-auto text-red-700">
